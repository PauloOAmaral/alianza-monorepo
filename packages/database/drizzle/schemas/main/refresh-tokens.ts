...
export const refreshTokens = pgTable(
    ...
    table => [
        ...
        index('refresh_tokens__user_type__user_context_id__revoked_at__expires_at_idx').on(table.userType, table.userContextId, table.revokedAt, table.expiresAt),
        ...
        foreignKey({
            ...
            name: 'refresh_tokens_user_context_id_fkey'
        })
    ]
)
