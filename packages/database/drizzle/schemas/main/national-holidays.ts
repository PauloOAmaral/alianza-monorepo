import { boolean, foreignKey, index, pgTable, timestamp, uniqueIndex, varchar } from 'drizzle-orm/pg-core'
...
export const nationalHolidays = pgTable(
    ...
    table => [
        ...
        uniqueIndex('national_holidays__country_id_date_name_key').on(table.countryId, table.date, table.name),
        foreignKey({
