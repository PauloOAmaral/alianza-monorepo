    ...
    return (
        <Card className='@container/card'>
            <CardHeader>
                ...
                <CardAction>
                    <ToggleGroup className='hidden *:data-[slot=toggle-group-item]:!px-4 @[767px]/card:flex' onValueChange={setTimeRange} type='single' value={timeRange} variant='outline'>
                        <ToggleGroupItem value='90d'>Last 3 months</ToggleGroupItem>
                        <ToggleGroupItem value='30d'>Last 30 days</ToggleGroupItem>
                        <ToggleGroupItem value='7d'>Last 7 days</ToggleGroupItem>
                    </ToggleGroup>
                    <Select onValueChange={setTimeRange} value={timeRange}>
                        <SelectTrigger aria-label='Select a value' className='flex w-40 **:data-[slot=select-value]:block **:data-[slot=select-value]:truncate @[767px]/card:hidden' size='sm'>
