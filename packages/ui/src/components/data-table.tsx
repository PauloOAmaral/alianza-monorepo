...
function DragHandle({ id }: { id: number }) {
    ...
    return (
        <Button {...attributes} {...listeners} className='text-muted-foreground size-7 hover:bg-transparent' size='icon' variant='ghost'>
                ...
                <div className='flex items-center justify-between px-4'>
                    ...
                    <div className='flex w-full items-center gap-8 lg:w-fit'>
                        ...
                        <div className='ml-auto flex items-center gap-2 lg:ml-0'>
                            ...
                            <Button className='hidden size-8 lg:flex' disabled={!table.getCanNextPage()} onClick={() => table.setPageIndex(table.getPageCount() - 1)} size='icon' variant='outline'>
