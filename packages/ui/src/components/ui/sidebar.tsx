...
function SidebarMenuButton({
    ...
    const button = (
        <Comp className={cn(sidebarMenuButtonVariants({ variant, size }), className)} data-active={isActive} data-sidebar='menu-button' data-size={size} data-slot='sidebar-menu-button' {...props} />
    )
