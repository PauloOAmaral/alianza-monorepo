...
function ComboboxTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
    return (
        <ComboboxPrimitive.Trigger className={cn("[&_svg:not([class*='size-'])]:size-4", className)} data-slot='combobox-trigger' {...props}>
            {children}
            <ChevronDownIcon className='text-muted-foreground pointer-events-none size-4' data-slot='combobox-trigger-icon' />
...
function ComboboxSeparator({ className, ...props }: ComboboxPrimitive.Separator.Props) {
    return <ComboboxPrimitive.Separator className={cn('bg-border -mx-1 my-1 h-px', className)} data-slot='combobox-separator' {...props} />
}
...
function ComboboxChip({
    ...
    return (
        ...
        >
            {children}
            {showRemove && (
                <ComboboxPrimitive.ChipRemove className='-ml-1 opacity-50 hover:opacity-100' data-slot='combobox-chip-remove' render={<Button size='icon-xs' variant='ghost' />}>
                    <XIcon className='pointer-events-none' />
