/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8fdff4b16d6d88316527be4ff64260e1)
// Runtime types generated with workerd@1.20251210.0 2025-04-04 nodejs_compat,nodejs_compat_populate_process_env
...
declare class URL {
    ...
    /**
     * The **`search`** property of the URL interface is a search string, also called a query string_, that is a string containing a `'?'` followed by the parameters of the URL.
     *
...
type Ai_Cf_Baai_Bge_M3_Input = Ai_Cf_Baai_Bge_M3_InputqueryAnd_Contexts | Ai_Cf_Baai_Bge_M3_Input_Embedding | {
    /**
     * Batch of the embeddings requests to run using async-queue
     */
    requests: (Ai_Cf_Baai_Bge_M3_InputqueryAnd_Contexts_1 | Ai_Cf_Baai_Bge_M3_Input_Embedding_1)[];
};
interface Ai_Cf_Baai_Bge_M3_InputqueryAnd_Contexts {
    /**
...
interface Ai_Cf_Baai_Bge_M3_InputqueryAnd_Contexts_1 {
    /**
     * A query you wish to perform against the provided contexts. If no query is provided the model with respond with embeddings for contexts
     */
    query?: string;
...
type Ai_Cf_Baai_Bge_M3_Output = Ai_Cf_Baai_Bge_M3_Ouputquery | Ai_Cf_Baai_Bge_M3_Output_EmbeddingFor_Contexts | Ai_Cf_Baai_Bge_M3_Ouput_Embedding | Ai_Cf_Baai_Bge_M3_AsyncResponse;
interface Ai_Cf_Baai_Bge_M3_Ouputquery {
    response?: {
        /**
