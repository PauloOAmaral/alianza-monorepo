    ...
    return (
        <Email previewText={previewText}>
            <Section>
                ...
                <Text className='text-black text-[14px] leading-[24px]'>Recebemos sua solicitação para redefinir sua senha. Por favor, clique no botão abaixo para criar uma nova senha:</Text>
                <Section className='text-center'>
                    <Button className='bg-[#1d4281] text-white border-none rounded-md px-4 py-2 mx-auto' href={`${baseUrl}/reset-password/${token}`}>
                        Redefinir senha
                    </Button>
                </Section>
            </Section>
