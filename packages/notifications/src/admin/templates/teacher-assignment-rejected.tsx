...
export const TeacherAssignmentRejectedHtml = ({
    analystFirstName,
    teacherName,
    studentName,
    rejectionReason,
    rejectedAt,
}: TeacherAssignmentRejectedProps) => {
    ...
    return (
        <Email previewText={previewText}>
            <Section>
                ...
                <Text className="text-black text-[14px] leading-[24px]">
                    O professor <strong>{teacherName}</strong> recusou a atribuição do aluno{" "}
                    <strong>{studentName}</strong>.
                </Text>

                <Section className="bg-[#f8d7da] border-l-4 border-[#dc3545] rounded-md p-[20px] my-[24px]">
                    <Text className="text-[#721c24] text-[14px] leading-[20px] m-0 font-semibold">
                        Status: Atribuição recusada
                    </Text>
                    <Text className="text-[#721c24] text-[12px] leading-[18px] m-0 mt-[8px]">
                        Recusado em: {rejectedAt}
                    </Text>
                    {rejectionReason && (
                        <>
                            <Text className="text-[#721c24] text-[12px] leading-[18px] m-0 mt-[12px] font-semibold">
                                Motivo:
                            </Text>
                            <Text className="text-[#721c24] text-[12px] leading-[18px] m-0 mt-[4px] italic">
                                "{rejectionReason}"
                            </Text>
                        </>
                    )}
                ...
                <Text className="text-black text-[14px] leading-[24px]">
                    O aluno retornou ao status de distribuição pendente e pode ser atribuído novamente a
                    outro professor.
                </Text>
            </Section>
        </Email>
...
export const TeacherAssignmentRejectedText = ({
    analystFirstName,
    teacherName,
    studentName,
    rejectionReason,
