...
export const TeacherAssignmentRequestHtml = ({
    ...
    return (
        <Email previewText={previewText}>
            <Section>
                <Heading className='text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0'>Nova Atribuição de Aluno</Heading>
                <Text className='text-black text-[14px] leading-[24px]'>Olá {teacherFirstName},</Text>
                <Text className='text-black text-[14px] leading-[24px]'>
                    A área de distribuições selecionou você para um novo aluno. Por favor, revise as informações abaixo e confirme se pode aceitar este aluno.
                </Text>

                <Hr className='border border-solid border-[#eaeaea] my-[26px] mx-0 w-full' />

                <Section className='bg-[#f6f9fc] rounded-md p-[20px] my-[16px]'>
                    <Heading className='text-black text-[18px] font-semibold mt-0 mb-[12px]'>Informações do Aluno</Heading>
                ...
                <Section className='bg-[#f6f9fc] rounded-md p-[20px] my-[16px]'>
                    <Heading className='text-black text-[18px] font-semibold mt-0 mb-[12px]'>Horários e Aulas</Heading>
                    <Text className='text-black text-[14px] leading-[20px] m-0 mb-[8px]'>
                ...
                <Section className='bg-[#f6f9fc] rounded-md p-[20px] my-[16px]'>
                    <Heading className='text-black text-[18px] font-semibold mt-0 mb-[12px]'>Informações Pedagógicas</Heading>
                    <Text className='text-black text-[14px] leading-[20px] m-0 mb-[8px]'>
                        <strong>Feedback da aula experimental:</strong>
                    </Text>
                    <Text className='text-black text-[14px] leading-[20px] m-0 mb-[12px] italic'>{experimentalFeedback}</Text>
                    {recommendedMaterial && (
                        <Text className='text-black text-[14px] leading-[20px] m-0 mb-[8px]'>
                ...
                <Text className='text-black text-[14px] leading-[24px] font-semibold'>Você tem 60 minutos para responder esta solicitação.</Text>

                <Section className='text-center mt-[32px]'>
                    <Button className='bg-[#28a745] text-white border-none rounded-md px-[32px] py-[12px] mx-[8px] text-[14px] font-semibold' href={`${baseUrl}/teacher/assignments/${token}/approve`}>
                        ✓ Aceitar Aluno
                    </Button>
                    <Button className='bg-[#dc3545] text-white border-none rounded-md px-[32px] py-[12px] mx-[8px] text-[14px] font-semibold' href={`${baseUrl}/teacher/assignments/${token}/reject`}>
                        ✗ Recusar
                    </Button>
                </Section>

                <Text className='text-[#666666] text-[12px] leading-[20px] text-center mt-[24px]'>Após 60 minutos sem resposta, esta atribuição será cancelada automaticamente.</Text>
            </Section>
        </Email>
    )
}
...
TeacherAssignmentRequestHtml.PreviewProps = {
    ...
    experimentalFeedback: 'Aluno demonstrou boa compreensão auditiva. Precisa desenvolver mais a produção oral e vocabulário.',
