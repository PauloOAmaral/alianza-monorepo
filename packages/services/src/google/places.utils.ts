...
export const numberFirstCommaCountries = ['BJ', 'BN', 'BY', 'CD', 'CG', 'IN', 'KG', 'KZ', 'LA', 'MD', 'MR', 'MU', 'MZ', 'SY', 'TG', 'TM', 'UA', 'VN', 'YE']
 ...
 */
export function formatAddressLine(streetNumber: string, route: string, countryCode?: string): string {
