        ...
        <FormField
            ...
            render={({ field }) => {
                ...
                function handleRemoveFile(fileToRemove: File) {
                    ...
                    const updatedFiles = files.filter((file: File) => getFileUniqueId(file) !== fileId)
                            ...
                            <div className='flex flex-col gap-4'>
                                {files.length > 0 && (
                                    <div className='grid grid-cols-3 gap-4'>
                                        {files.map((file: File) => (
                                            <div className='border rounded p-3 flex items-center justify-between bg-white' key={getFileUniqueId(file)}>
