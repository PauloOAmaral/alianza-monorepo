...
function ExcelCellField<TFieldValues extends FieldValues = FieldValues>({ name }: ExcelCellFieldProps<TFieldValues>) {
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl className='border-0'>
                        <Input {...field} className='border-0 shadow-0 h-full focus-visible:ring-0 focus-visible:border-0 focus:outline-0 focus:border-none w-full px-1 py-2 rounded-none text-sm' />
                    </FormControl>
                </FormItem>
            )}
        />
