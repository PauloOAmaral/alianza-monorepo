...
export function StatusDisplayField({ label, badgeText, badgeColor = 'green', description }: StatusDisplayFieldProps) {
    ...
    return (
        <div>
            ...
            <div className='flex items-start gap-4'>
                <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-md ${badgeColorClasses[badgeColor]}`}>
