...
function ExcelSelectField<TFieldValues extends FieldValues = FieldValues>({
    name,
    items,
    className,
    onSelectionChange,
    renderItem,
}: ExcelSelectFieldProps<TFieldValues>) {
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <Select
                            buttonClassName={
                                "border-0 shadow-none h-full focus-visible:ring-0 focus:outline-0 focus:border-0 w-full rounded-none text-xs"
                            }
                            className={
                                className ||
                                "border-0 shadow-none h-full focus-visible:ring-0 focus:outline-0 focus:border-0 w-full rounded-none text-xs"
