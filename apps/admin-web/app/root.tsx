...
import { data, isRouteErrorResponse, Links, Meta, Outlet, Scripts, ScrollRestoration, useLoaderData } from 'react-router'
import { getToast } from 'remix-toast'
import { ToastMessages } from '~/components/shared/toast-message'
import type { Route } from './+types/root'
import { getLocale, serializeLocaleCookie } from './middleware/i18next-middleware'
...
export async function loader({ request }: Route.LoaderArgs) {
    ...
    headers.append('Set-Cookie', await serializeLocaleCookie(request))
