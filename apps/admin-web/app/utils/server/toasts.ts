import {
  dataWithError as dataWithErrorToast,
  dataWithSuccess as dataWithSuccessToast,
  redirectWithError as redirectWithErrorToast,
  redirectWithSuccess as redirectWithSuccessToast,
} from "remix-toast"

export async function dataWithSuccess<T>(
  data: T,
  toastMessage: string,
  init?: ResponseInit,
) {
...
export async function dataWithError<T>(
  data: T,
