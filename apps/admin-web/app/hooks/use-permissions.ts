...
export function usePermissions() {
     ...
     */
    function hasPermission(permission: PermissionType | PermissionType[], mode: 'some' | 'all' = 'all') {
        ...
        return mode === 'some' ? permissions.some(p => userSession.permissions.includes(p)) : permissions.every(p => userSession.permissions.includes(p))
    }
